...
class ApproximateSARSAAgent(Agent):
    ...
    def final(self, state):
        ...
        nextAction = self.computeActionFromQValues(state) if state.getLegalActions() else None
        self.update(self.lastState, self.lastAction, state, deltaReward, nextAction)
